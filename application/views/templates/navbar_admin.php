  ...
  <div class="collapse navbar-collapse" id="navbarColor03">
	...
	<ul class="nav navbar-nav navbar-right">
        <li class="nav-item dropdown active">
          <a href="#" class="nav-link" data-placement="left" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> <div class="navbar-brand" ><?php echo $usersx->username ?></div> <i class="fa fa-cog fa-2x"></i> </a>
